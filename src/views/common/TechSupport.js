...
const TechnicalSupport = () => {
    ...
    const submitHandler = (e) => {
        ...
        setLoading(true)
            axios.post('/api/user/technicalsupport',formValues)
            .then(()=> {
            ...
            <div className='container'> 
                ...
                <div className='row'>
                    <div className="fullwidth">
                        <label className="form-control insize bg-secondary text-white mb-4" >Technical Support</label>
                    </div>
                    <div className='col-6'>
                        ...
                        <div>
                            ...
                            <div className="form-group ">
                                <label htmlFor="email"> Subject <span className='text-danger'>*</span></label>
                                <input
                            ...
                            <button type="submit" className="theme-btn mt-2  text-right " disabled={loading} 
